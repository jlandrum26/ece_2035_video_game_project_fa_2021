...
/**
 * Add a DOOR at (x,y). If a MapItem already exists there, erase it.
 */
void add_door(int x, int y);

/**
 * Add an NPC at (x,y). If a MapItem already exits there, erase it.
 */
void add_npc(int x, int y);

/**
 * Add a BOSS at (x,y). If a MapItem already exists there, erase it.
 */
void add_boss(int x, int y);

/**
 * Add a GATE at (x,y). If a MapItem already exists there, erase it.
 */
void add_gate(int x, int y, int dir, int len);

/**
 * Add a SPELL at (x,y). If a MapItem already exists there, erase it.
 */
void add_spell(int x, int y);

/**
 * Add a FAKE (fake spell) at (x,y). If a MapItem already exists there, erase it.
 */
void add_fake(int x, int y);

/**
 * Add a DAWG at (x,y). If a MapItem already exists there, erase it.
 */
void add_dawg(int x, int y);

/**
 * Add a GRAVE at (x,y). If a MapItem already exists there, erase it.
 */
void add_grave(int x, int y);

/**
 * Add an ALT at (x,y). If a MapItem already exists there, erase it.
 */
//void add_alt(int x, int y);

/**
 * Add a CLEM at (x, y). If a MapItem already exists there, erase it.
 */
//void add_tiger(int x, int y);

/**
 * Add a CLGR at (x, y). If a MapItem already exists there, erase it.
 */
//void add_ctomb(int x, int y);

/**
 * Add a FAN at (x, y). If a MapItem already exists there, erase it.
 */
